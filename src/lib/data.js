...
export const CAT_COLOR = {
  Diabetes:'#4F46E5', Kidneys:'#0891B2', Lipids:'#DC2626',
  Blood:'#DB2777', Electrolytes:'#D97706', Liver:'#16A34A',
  Vitals:'#7C3AED', Other:'#6B7280',
}
...
export const STATUS_C  = { crit:'#EF4444', warn:'#F59E0B', ok:'#10B981' }
export const STATUS_BG = { crit:'#FEF2F2', warn:'#FFFBEB', ok:'#ECFDF5' }
export const STATUS_BD = { crit:'#FECACA', warn:'#FDE68A', ok:'#A7F3D0' }
export const STATUS_LB = { crit:'Critical', warn:'High', ok:'Normal' }

export const gc  = (f, v) => STATUS_C[getStatus(f, v)]
